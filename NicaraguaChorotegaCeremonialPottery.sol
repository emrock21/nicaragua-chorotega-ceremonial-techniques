...
contract NicaraguaChorotegaCeremonialPottery {

    struct CeremonialTechnique {
        string region;          // e.g., Masaya, Carazo, Granada
        string community;       // San Juan de Oriente, Catarina, Diriomo, etc.
        string techniqueName;   // engobe rojo, pintura negativa, incision geometrica, etc.
        string materialType;    // volcanic clay, red clay, mixed clay
        string culturalNote;    // archaeological or ethnographic fact
    ...
    CeremonialTechnique[] public techniques;
    ...
    function voteTechnique(uint256 id, bool like) external {
        ...
        CeremonialTechnique storage t = techniques[id];
